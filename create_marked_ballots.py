...
if __name__ == "__main__":
	...
	parser.add_argument("--include-oregon", help="Create marked up ballots for Oregon.", action='store_true')
	parser.add_argument("--include-montana", help="Create marked up ballots for Montana.", action='store_true')
